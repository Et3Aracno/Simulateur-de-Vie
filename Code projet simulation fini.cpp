...
public:
    ...
    void gestionNourriture() {
        ...
        cout << "                 EN DETENTE, LES HERBIVORES SE NOURRISSENT " << endl << endl << endl;
    ...
    void afficherInfos() {
    cout << "                  INFORMATIONS DE NOS BEAUX DINOSAURES" << endl << endl << endl;
    ...
    void Mort() {
        cout << "             INFORMATIONS SUR LES SOLDATS MORT POUR LA PATRIE " << endl << endl << endl;
